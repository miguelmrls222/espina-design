...
function renderProductCard(p, index, opts = {}) {
  ...
  const wrapperClass = carousel
    ? 'flex-shrink-0 w-[220px] sm:w-[260px] group flex flex-col snap-start bg-white rounded-xl border border-gray-200/50 shadow-sm hover:shadow-md transition-shadow p-4'
    : 'group flex flex-col bg-white rounded-xl border border-gray-200/50 shadow-sm hover:shadow-md transition-shadow p-4'
